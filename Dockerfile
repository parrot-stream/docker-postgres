...
RUN apt-get update -y; \
    ...
    apt-get install -y --no-install-recommends --force-yes git g++ pkg-config software-properties-common cmake postgresql-server-dev-${PG_MAJOR} libpq-dev make libproj-dev liblwgeom-dev; \
